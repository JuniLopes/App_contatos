    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Atividade` (`nome` TEXT NOT NULL, `endereco` TEXT NOT NULL, `telefone` TEXT NOT NULL, `codigo` INTEGER PRIMARY KEY AUTOINCREMENT, `dataDeCriacao` TEXT NOT NULL)');
